...
impl Document {
    ...
    pub fn sender_id(&self) -> &str {
        match self {
            ...
            Self::StatusRequest(d) => d.sender_m_rid.value.as_str(),
            Self::Unavailability(d) => d.sender_m_rid.value.as_str(),
            Self::Kaskade(d) => d.sender_m_rid.value.as_str(),
    ...
    pub fn receiver_id(&self) -> &str {
        match self {
            ...
            Self::StatusRequest(d) => d.receiver_m_rid.value.as_str(),
            Self::Unavailability(d) => d.receiver_m_rid.value.as_str(),
            Self::Kaskade(d) => d.receiver_m_rid.value.as_str(),
