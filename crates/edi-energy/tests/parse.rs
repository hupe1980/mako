...
UNB+UNOC:3+9900111222333:500+9900444555666:500+230701:0800+INTER001'\
UNH+MSG001+UTILMD:D:11A:UN:5.5.3a'\
BGM+E03+11001+9'\
DTM+137:202307010800?+00:303'\
UNT+4+MSG001'\
...
UNB+UNOC:3+4012345000023:14+9900357000004:500+200101:0000+1'\
...
/// on `ParseConfig` and read by nothing, every caller reaching for it to pin a
/// Formatversion would silently get the undisambiguated profile instead — and a
/// test that passes only until the next BDEW cutover is worse than no test.
#[cfg(feature = "mscons")]
#[test]
