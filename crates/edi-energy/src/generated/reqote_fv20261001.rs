    ...
    Arc::new(
        ProfileRulePack::new("REQOTE-MIG-1.3c")
            ...
            .with_named_group_rule_fn(
                "MIG-REQOTE-MIG-1.3c-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-REQOTE-MIG-1.3c-GROUP-SG11-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REQOTE-MIG-1.3c-GROUP-SG27-LIN-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REQOTE-MIG-1.3c-GROUP-SG1-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REQOTE-MIG-1.3c-GROUP-SG11-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static AHB_35001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REQOTE-AHB-1.3c-35001")
            .for_message_type("REQOTE")
            .for_release("1.3c")
            .with_named_rule_fn("AHB-35001-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-35001-BGM-M",
            ...
            .with_named_rule_fn("AHB-35001-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-35001-COM-M",
            ...
            .with_named_rule_fn("AHB-35001-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-35001-CTA-M",
            ...
            .with_named_rule_fn("AHB-35001-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-35001-DTM-M",
            ...
            .with_named_rule_fn("AHB-35001-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-35001-LIN-M",
            ...
            .with_named_rule_fn("AHB-35001-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-35001-LOC-M",
            ...
            .with_named_rule_fn("AHB-35001-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-35001-NAD-M",
            ...
            .with_named_rule_fn("AHB-35001-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-35001-RFF-M",
...
static AHB_35002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REQOTE-AHB-1.3c-35002")
            .for_message_type("REQOTE")
            .for_release("1.3c")
            .with_named_rule_fn("AHB-35002-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-35002-BGM-M",
            ...
            .with_named_rule_fn("AHB-35002-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-35002-COM-M",
            ...
            .with_named_rule_fn("AHB-35002-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-35002-CTA-M",
            ...
            .with_named_rule_fn("AHB-35002-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-35002-DTM-M",
            ...
            .with_named_rule_fn("AHB-35002-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-35002-LIN-M",
            ...
            .with_named_rule_fn("AHB-35002-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-35002-LOC-M",
            ...
            .with_named_rule_fn("AHB-35002-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-35002-NAD-M",
            ...
            .with_named_rule_fn("AHB-35002-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-35002-RFF-M",
...
static AHB_35003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REQOTE-AHB-1.3c-35003")
            .for_message_type("REQOTE")
            .for_release("1.3c")
            .with_named_rule_fn("AHB-35003-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-35003-BGM-M",
            ...
            .with_named_rule_fn("AHB-35003-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-35003-COM-M",
            ...
            .with_named_rule_fn("AHB-35003-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-35003-CTA-M",
            ...
            .with_named_rule_fn("AHB-35003-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-35003-DTM-M",
            ...
            .with_named_rule_fn("AHB-35003-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-35003-LOC-M",
            ...
            .with_named_rule_fn("AHB-35003-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-35003-NAD-M",
            ...
            .with_named_rule_fn("AHB-35003-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-35003-RFF-M",
            ...
            .with_named_rule_fn("AHB-35003-LIN-S", |segs, issues| {
                ahb_check_soll(
                    segs,
                    "LIN",
                    "AHB-35003-LIN-S",
            ...
            .with_named_rule_fn("AHB-35003-PIA-S", |segs, issues| {
                ahb_check_soll(
                    segs,
                    "PIA",
                    "AHB-35003-PIA-S",
...
static AHB_35004_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REQOTE-AHB-1.3c-35004")
            .for_message_type("REQOTE")
            .for_release("1.3c")
            .with_named_rule_fn("AHB-35004-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-35004-BGM-M",
            ...
            .with_named_rule_fn("AHB-35004-CCI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CCI",
                    "AHB-35004-CCI-M",
            ...
            .with_named_rule_fn("AHB-35004-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-35004-COM-M",
            ...
            .with_named_rule_fn("AHB-35004-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-35004-CTA-M",
            ...
            .with_named_rule_fn("AHB-35004-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-35004-DTM-M",
            ...
            .with_named_rule_fn("AHB-35004-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-35004-FTX-M",
            ...
            .with_named_rule_fn("AHB-35004-IMD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "IMD",
                    "AHB-35004-IMD-M",
            ...
            .with_named_rule_fn("AHB-35004-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-35004-LIN-M",
            ...
            .with_named_rule_fn("AHB-35004-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-35004-LOC-M",
            ...
            .with_named_rule_fn("AHB-35004-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-35004-NAD-M",
            ...
            .with_rule_fn(rule_ahb_35004_nad_cond_0)
            .with_named_rule_fn("AHB-35004-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-35004-PIA-M",
            ...
            .with_named_rule_fn("AHB-35004-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-35004-RFF-M",
...
static AHB_35005_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REQOTE-AHB-1.3c-35005")
            .for_message_type("REQOTE")
            .for_release("1.3c")
            .with_named_rule_fn("AHB-35005-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-35005-BGM-M",
            ...
            .with_named_rule_fn("AHB-35005-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-35005-COM-M",
            ...
            .with_named_rule_fn("AHB-35005-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-35005-DTM-M",
            ...
            .with_named_rule_fn("AHB-35005-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-35005-LIN-M",
            ...
            .with_named_rule_fn("AHB-35005-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-35005-LOC-M",
            ...
            .with_named_rule_fn("AHB-35005-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-35005-NAD-M",
            ...
            .with_named_rule_fn("AHB-35005-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-35005-PIA-M",
            ...
            .with_named_rule_fn("AHB-35005-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-35005-RFF-M",
...
static RELEASE_REQOTE_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("1.3c"));

pub(crate) struct ReqoteFv20261001Profile;

impl Profile for ReqoteFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Reqote
    }
    fn release(&self) -> &Release {
        &RELEASE_REQOTE_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("REQOTE MIG 1.3c, Publikationsdatum 01.04.2026")
    }
...
pub(crate) static PROFILE: ReqoteFv20261001Profile = ReqoteFv20261001Profile;
