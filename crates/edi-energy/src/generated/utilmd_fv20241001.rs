    ...
    Arc::new(
        ProfileRulePack::new("UTILMD-MIG-S1.1a")
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.1a-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.1a-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.1a-GROUP-SG4-IDE-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.1a-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.1a-GROUP-SG4-IDE-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
impl Profile for UtilmdFv20241001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilmd
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILMD_FV20241001
    }
...
pub(crate) static PROFILE: UtilmdFv20241001Profile = UtilmdFv20241001Profile;
