...
static MIG_COMDIS_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("COMDIS-MIG-1.0g")
            ...
            .with_rule_fn(rule_ajt_mandatory)
            .with_named_group_rule_fn(
                "MIG-COMDIS-MIG-1.0g-GROUP-SG1-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-COMDIS-MIG-1.0g-GROUP-SG2-DOC-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg2_doc_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-COMDIS-MIG-1.0g-GROUP-SG1-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-COMDIS-MIG-1.0g-GROUP-SG2-DOC-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg2_doc_min_occurrences(g, segs, issues);
                    }
                },
            )
...
static AHB_29001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("COMDIS-AHB-1.0g-29001")
            .for_message_type("COMDIS")
            .for_release("1.0g")
            .with_named_rule_fn("AHB-29001-AJT-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "AJT",
                    "AHB-29001-AJT-M",
            ...
            .with_named_rule_fn("AHB-29001-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-29001-COM-M",
            ...
            .with_named_rule_fn("AHB-29001-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-29001-CTA-M",
            ...
            .with_named_rule_fn("AHB-29001-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-29001-CUX-M",
            ...
            .with_named_rule_fn("AHB-29001-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-29001-DOC-M",
            ...
            .with_named_rule_fn("AHB-29001-MOA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "MOA",
                    "AHB-29001-MOA-M",
...
static AHB_29002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("COMDIS-AHB-1.0g-29002")
            .for_message_type("COMDIS")
            .for_release("1.0g")
            .with_named_rule_fn("AHB-29002-AJT-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "AJT",
                    "AHB-29002-AJT-M",
            ...
            .with_named_rule_fn("AHB-29002-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-29002-COM-M",
            ...
            .with_named_rule_fn("AHB-29002-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-29002-CTA-M",
            ...
            .with_named_rule_fn("AHB-29002-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-29002-DOC-M",
...
static RELEASE_COMDIS_FV20260401: LazyLock<Release> = LazyLock::new(|| Release::new("1.0g"));

pub(crate) struct ComdisFv20260401Profile;

impl Profile for ComdisFv20260401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Comdis
    }
    fn release(&self) -> &Release {
        &RELEASE_COMDIS_FV20260401
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("COMDIS MIG 1.0g, Publikationsdatum 01.10.2025")
    }
...
pub(crate) static PROFILE: ComdisFv20260401Profile = ComdisFv20260401Profile;
