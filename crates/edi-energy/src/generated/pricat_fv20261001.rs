    ...
    Arc::new(
        ProfileRulePack::new("PRICAT-MIG-2.1")
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.1-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.1-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.1-GROUP-SG6-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.1-GROUP-SG17-PGI-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.1-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static RELEASE_PRICAT_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("2.1"));

pub(crate) struct PricatFv20261001Profile;

impl Profile for PricatFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Pricat
    }
    fn release(&self) -> &Release {
        &RELEASE_PRICAT_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("PRICAT MIG 2.1, Publikationsdatum 01.04.2026")
    }
...
pub(crate) static PROFILE: PricatFv20261001Profile = PricatFv20261001Profile;
