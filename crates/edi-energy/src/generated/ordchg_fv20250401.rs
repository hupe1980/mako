...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    const DETAIL_GROUP_TRIGGERS: &[&str] = &["RFF", "NAD", "CTA"];
    ...
    Arc::new(
        ProfileRulePack::new("ORDCHG-MIG-1.1")
            ...
            .with_named_group_rule_fn(
                "MIG-ORDCHG-MIG-1.1-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDCHG-MIG-1.1-GROUP-SG3-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDCHG-MIG-1.1-GROUP-SG1-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDCHG-MIG-1.1-GROUP-SG3-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static RELEASE_ORDCHG_FV20250401: LazyLock<Release> = LazyLock::new(|| Release::new("1.1"));

pub(crate) struct OrdchgFv20250401Profile;

impl Profile for OrdchgFv20250401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Ordchg
    }
    fn release(&self) -> &Release {
        &RELEASE_ORDCHG_FV20250401
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("ORDCHG MIG 1.1, Publikationsdatum 01.10.2024")
    }
...
pub(crate) static PROFILE: OrdchgFv20250401Profile = OrdchgFv20250401Profile;
