...
static RELEASE_MSCONS_FV20240401: LazyLock<Release> = LazyLock::new(|| Release::new("2.4c"));

pub(crate) struct MsconsFv20240401Profile;

impl Profile for MsconsFv20240401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Mscons
    }
    fn release(&self) -> &Release {
        &RELEASE_MSCONS_FV20240401
    }
    fn valid_from(&self) -> Option<::time::Date> {
        Some(::time::macros::date!(2024 - 04 - 01))
    }
...
pub(crate) static PROFILE: MsconsFv20240401Profile = MsconsFv20240401Profile;
