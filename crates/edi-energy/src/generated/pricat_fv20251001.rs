...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "RFF",
        "Referenz/Prüfidentifikator",
        &[ElementRef::new(1, "C506", Status::Mandatory, 1)],
    ),
    SegmentDefinition::new(
        "NAD",
        "MP-ID Empfänger/Absender",
        &[
    ...
    SegmentDefinition::new(
        ...
        &[ElementRef::new(1, "5379", Status::Mandatory, 1)],
    ),
    SegmentDefinition::new(
        "LIN",
        "Positionsdaten",
...
static DIRECTORY_VALIDATOR_PRICAT_2_0E: LazyLock<DirectoryValidator> = LazyLock::new(|| {
    DirectoryValidator::new(
        "EDI@Energy-PRICAT-2.0e",
        segment_lookup,
        is_code_valid,
        suggest_code,
        expected_components,
...
pub(crate) fn directory_validator() -> &'static DirectoryValidator {
    &DIRECTORY_VALIDATOR_PRICAT_2_0E
}
...
fn rule_group_sg1_rff_max_occurrences(
    ...
    if count > 99 {
        issues.push(
            ...
            .with_rule_id("MIG-PRICAT-MIG-2.0e-GROUP-SG1-RFF-CARD-MAX")
...
fn rule_group_sg2_nad_max_occurrences(
    ...
    if count > 99 {
        issues.push(
            ...
            .with_rule_id("MIG-PRICAT-MIG-2.0e-GROUP-SG2-NAD-CARD-MAX")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
/// trigger is not charged here.  The MIG specifies a maximum of 20 instances.
fn rule_group_sg6_cux_max_occurrences(
    _root: &edifact_rs::SegmentGroupIndexed<'_>,
    segments: &[edifact_rs::Segment<'_>],
    issues: &mut Vec<ValidationIssue>,
) {
    // SG6 is not in GROUP_SCHEMA, so the tree cannot count it.
    ...
    if count > 20 {
        issues.push(
            ...
            .with_rule_id("MIG-PRICAT-MIG-2.0e-GROUP-SG6-CUX-CARD-MAX")
...
///
/// Counted over the group tree, so a nested group sharing the `PGI`
/// trigger is not charged here.  The MIG specifies a maximum of 1000 instances.
fn rule_group_sg17_pgi_max_occurrences(
    _root: &edifact_rs::SegmentGroupIndexed<'_>,
    segments: &[edifact_rs::Segment<'_>],
    issues: &mut Vec<ValidationIssue>,
) {
    // SG17 is not in GROUP_SCHEMA, so the tree cannot count it.
    ...
    if count > 1_000 {
        issues.push(
            ...
            .with_rule_id("MIG-PRICAT-MIG-2.0e-GROUP-SG17-PGI-CARD-MAX")
...
fn rule_group_sg2_nad_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-PRICAT-MIG-2.0e-GROUP-SG2-NAD-CARD-MIN")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-PRICAT-MIG-2.0e-ORDER", issues);
}

static MIG_PRICAT_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("PRICAT-MIG-2.0e")
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.0e-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.0e-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.0e-GROUP-SG6-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg6_cux_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.0e-GROUP-SG17-PGI-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg17_pgi_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-PRICAT-MIG-2.0e-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static AHB_27001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("PRICAT-AHB-2.0e-27001")
            .for_message_type("PRICAT")
            .for_release("2.0e")
            .with_named_rule_fn("AHB-27001-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-27001-BGM-M",
            ...
            .with_named_rule_fn("AHB-27001-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-27001-CUX-M",
            ...
            .with_named_rule_fn("AHB-27001-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-27001-DTM-M",
            ...
            .with_rule_fn(rule_ahb_27001_imd_cond_0)
            .with_named_rule_fn("AHB-27001-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-27001-LIN-M",
            ...
            .with_named_rule_fn("AHB-27001-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-27001-LOC-M",
            ...
            .with_named_rule_fn("AHB-27001-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-27001-NAD-M",
            ...
            .with_named_rule_fn("AHB-27001-PGI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PGI",
                    "AHB-27001-PGI-M",
            ...
            .with_rule_fn(rule_ahb_27001_pia_cond_0)
            .with_named_rule_fn("AHB-27001-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-27001-PRI-M",
            ...
            .with_named_rule_fn("AHB-27001-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-27001-RFF-M",
            ...
            .with_rule_fn(rule_ahb_27001_rng_cond_0)
            .with_rule_fn(rule_ahb_27001_rng_cond_1)
...
static AHB_27002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("PRICAT-AHB-2.0e-27002")
            .for_message_type("PRICAT")
            .for_release("2.0e")
            .with_named_rule_fn("AHB-27002-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-27002-BGM-M",
            ...
            .with_named_rule_fn("AHB-27002-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-27002-CUX-M",
            ...
            .with_named_rule_fn("AHB-27002-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-27002-DTM-M",
            ...
            .with_named_rule_fn("AHB-27002-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-27002-LIN-M",
            ...
            .with_named_rule_fn("AHB-27002-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-27002-NAD-M",
            ...
            .with_named_rule_fn("AHB-27002-PGI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PGI",
                    "AHB-27002-PGI-M",
            ...
            .with_named_rule_fn("AHB-27002-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-27002-PRI-M",
            ...
            .with_named_rule_fn("AHB-27002-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-27002-RFF-M",
            ...
            .with_rule_fn(rule_ahb_27002_pia_cond_0)
            .with_rule_fn(rule_ahb_27002_imd_cond_0)
            .with_rule_fn(rule_ahb_27002_rng_cond_0)
            .with_rule_fn(rule_ahb_27002_rng_cond_1)
            .with_max_issues_per_rule(50),
    )
});
...
static AHB_27003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("PRICAT-AHB-2.0e-27003")
            .for_message_type("PRICAT")
            .for_release("2.0e")
            .with_named_rule_fn("AHB-27003-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-27003-BGM-M",
            ...
            .with_named_rule_fn("AHB-27003-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-27003-CUX-M",
            ...
            .with_named_rule_fn("AHB-27003-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-27003-DTM-M",
            ...
            .with_named_rule_fn("AHB-27003-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-27003-LIN-M",
            ...
            .with_named_rule_fn("AHB-27003-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-27003-NAD-M",
            ...
            .with_named_rule_fn("AHB-27003-PGI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PGI",
                    "AHB-27003-PGI-M",
            ...
            .with_named_rule_fn("AHB-27003-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-27003-PRI-M",
            ...
            .with_named_rule_fn("AHB-27003-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-27003-RFF-M",
            ...
            .with_named_rule_fn("AHB-27003-RNG-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RNG",
                    "AHB-27003-RNG-M",
...
static AHB_ALL_PACK_PRICAT_2_0E: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    let pack = ProfileRulePack::new("PRICAT-AHB-2.0e-ALL")
        .for_message_type("PRICAT")
        .for_release("2.0e");
    let pack = pack
...
pub(crate) fn ahb_rule_pack(pid: Option<Pruefidentifikator>) -> Arc<ProfileRulePack> {
    match pid.map(super::super::pruefidentifikator::Pruefidentifikator::as_u32) {
            ...
            None => Arc::clone(&AHB_ALL_PACK_PRICAT_2_0E),
...
static RELEASE_PRICAT_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("2.0e"));

pub(crate) struct PricatFv20251001Profile;

impl Profile for PricatFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Pricat
    }
    fn release(&self) -> &Release {
        &RELEASE_PRICAT_FV20251001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("PRICAT MIG 2.0e, Publikationsdatum 01.04.2025")
    }
...
pub(crate) static PROFILE: PricatFv20251001Profile = PricatFv20251001Profile;
