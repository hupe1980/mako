...
static RELEASE_PRICAT_FV20250401: LazyLock<Release> = LazyLock::new(|| Release::new("2.0e"));

pub(crate) struct PricatFv20250401Profile;

impl Profile for PricatFv20250401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Pricat
    }
    fn release(&self) -> &Release {
        &RELEASE_PRICAT_FV20250401
    }
...
pub(crate) static PROFILE: PricatFv20250401Profile = PricatFv20250401Profile;
