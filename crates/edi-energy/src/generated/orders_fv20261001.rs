    ...
    Arc::new(
        ProfileRulePack::new("ORDERS-MIG-1.4c")
            ...
            .with_named_group_rule_fn(
                "MIG-ORDERS-MIG-1.4c-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDERS-MIG-1.4c-GROUP-SG29-LIN-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDERS-MIG-1.4c-GROUP-SG1-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-ORDERS-MIG-1.4c-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static RELEASE_ORDERS_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("1.4c"));

pub(crate) struct OrdersFv20261001Profile;

impl Profile for OrdersFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Orders
    }
    fn release(&self) -> &Release {
        &RELEASE_ORDERS_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("ORDERS MIG 1.4c, Publikationsdatum 01.04.2026")
    }
...
pub(crate) static PROFILE: OrdersFv20261001Profile = OrdersFv20261001Profile;
