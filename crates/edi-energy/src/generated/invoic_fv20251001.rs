...
static RELEASE_INVOIC_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("2.8e"));

pub(crate) struct InvoicFv20251001Profile;

impl Profile for InvoicFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Invoic
    }
    fn release(&self) -> &Release {
        &RELEASE_INVOIC_FV20251001
    }
...
pub(crate) static PROFILE: InvoicFv20251001Profile = InvoicFv20251001Profile;
