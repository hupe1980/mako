...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-INSRPT-MIG-1.1a-ORDER", issues);
}
...
static RELEASE_INSRPT_FV20260101: LazyLock<Release> = LazyLock::new(|| Release::new("1.1a"));

pub(crate) struct InsrptFv20260101Profile;

impl Profile for InsrptFv20260101Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Insrpt
    }
    fn release(&self) -> &Release {
        &RELEASE_INSRPT_FV20260101
    }
...
pub(crate) static PROFILE: InsrptFv20260101Profile = InsrptFv20260101Profile;
