...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-APERAK-MIG-2.1i-ORDER", issues);
}
    ...
    Arc::new(
        ProfileRulePack::new("APERAK-MIG-2.1i")
            ...
            .with_named_group_rule_fn(
                "MIG-APERAK-MIG-2.1i-GROUP-SG3-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-APERAK-MIG-2.1i-GROUP-SG4-ERC-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-APERAK-MIG-2.1i-GROUP-SG2-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-APERAK-MIG-2.1i-GROUP-SG3-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
impl Profile for AperakFv20251001Profile {
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("APERAK MIG 2.1i, Publikationsdatum 01.04.2025")
    }
