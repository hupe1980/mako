...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "EFI",
        "Ansicht des Senders / Privilegierte Energiemenge",
    ...
    Arc::new(
        ProfileRulePack::new("IFTSTA-MIG-2.1")
            ...
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.1-GROUP-SG1-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.1-GROUP-SG4-EQD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.1-GROUP-SG14-CNI-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.1-GROUP-SG1-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
impl Profile for IftstaFv20261001Profile {
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("IFTSTA MIG 2.1, Publikationsdatum 01.04.2026")
    }
