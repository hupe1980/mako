...
static DIRECTORY_VALIDATOR_UTILMD_S1_2: LazyLock<DirectoryValidator> = LazyLock::new(|| {
    DirectoryValidator::new(
        "EDI@Energy-UTILMD-S1.2",
        segment_lookup,
        is_code_valid,
        suggest_code,
        expected_components,
...
pub(crate) fn directory_validator() -> &'static DirectoryValidator {
    &DIRECTORY_VALIDATOR_UTILMD_S1_2
}
...
fn rule_group_sg1_rff_max_occurrences(
    ...
    if count > 99 {
        issues.push(
            ...
            .with_rule_id("MIG-UTILMD-MIG-S1.2-GROUP-SG1-RFF-CARD-MAX")
            .with_segment("RFF".to_owned()),
        );
    }
}
...
fn rule_group_sg2_nad_max_occurrences(
    ...
    if count > 99 {
        issues.push(
            ...
            .with_rule_id("MIG-UTILMD-MIG-S1.2-GROUP-SG2-NAD-CARD-MAX")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_group_sg4_ide_max_occurrences(
    ...
    if count > 9_999 {
        issues.push(
            ...
            .with_rule_id("MIG-UTILMD-MIG-S1.2-GROUP-SG4-IDE-CARD-MAX")
            .with_segment("IDE".to_owned()),
        );
    }
}
...
fn rule_group_sg2_nad_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-UTILMD-MIG-S1.2-GROUP-SG2-NAD-CARD-MIN")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_group_sg4_ide_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-UTILMD-MIG-S1.2-GROUP-SG4-IDE-CARD-MIN")
            .with_segment("IDE".to_owned()),
        );
    }
}
...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-UTILMD-MIG-S1.2-ORDER", issues);
}

static MIG_UTILMD_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("UTILMD-MIG-S1.2")
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.2-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.2-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.2-GROUP-SG4-IDE-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.2-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-S1.2-GROUP-SG4-IDE-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static AHB_55001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55001")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55002")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55003")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55004_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55004")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55005_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55005")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55006_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55006")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_55017_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55017")
            .for_message_type("UTILMD")
            .for_release("S1.2")
            ...
            .with_named_rule_fn("AHB-55017-BGM-1001-Q", |segs, issues| {
                ahb_check_qualifier(segs, "BGM", "AHB-55017-BGM-1001-Q", "segment BGM DE 1001 (element 0, component 0): qualifier is not one of the allowed values ['E01']", |q| matches!(q, "E01"), "55017", issues);
            })
...
static AHB_55018_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55018")
            .for_message_type("UTILMD")
            .for_release("S1.2")
            ...
            .with_named_rule_fn("AHB-55018-BGM-1001-Q", |segs, issues| {
                ahb_check_qualifier(segs, "BGM", "AHB-55018-BGM-1001-Q", "segment BGM DE 1001 (element 0, component 0): qualifier is not one of the allowed values ['E01']", |q| matches!(q, "E01"), "55018", issues);
            })
...
static AHB_55555_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-S1.2-55555")
            .for_message_type("UTILMD")
            .for_release("S1.2")
...
static AHB_ALL_PACK_UTILMD_S1_2: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    let pack = ProfileRulePack::new("UTILMD-AHB-S1.2-ALL")
        .for_message_type("UTILMD")
        .for_release("S1.2");
    let pack = pack
...
pub(crate) fn ahb_rule_pack(pid: Option<Pruefidentifikator>) -> Arc<ProfileRulePack> {
    match pid.map(super::super::pruefidentifikator::Pruefidentifikator::as_u32) {
            ...
            None => Arc::clone(&AHB_ALL_PACK_UTILMD_S1_2),
...
static RELEASE_UTILMD_FV20250606: LazyLock<Release> = LazyLock::new(|| Release::new("S1.2"));

pub(crate) struct UtilmdFv20250606Profile;

impl Profile for UtilmdFv20250606Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilmd
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILMD_FV20250606
    }
    fn valid_from(&self) -> Option<::time::Date> {
        Some(::time::macros::date!(2025 - 06 - 06))
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some(
            "UTILMD MIG S1.2 — LFW24 MpBNr2 (BK6-22-024 transitional release, effective 2025-06-06): MPES Einspeisung PIDs transferred to GPKE. Derived from UTILMD MIG S2.1 konsolidierte Lesefassung (message structure unchanged); PID set extended per BK6-22-024 Anlage 4.",
        )
    }
...
pub(crate) static PROFILE: UtilmdFv20250606Profile = UtilmdFv20250606Profile;
