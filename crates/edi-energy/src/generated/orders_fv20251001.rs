...
static RELEASE_ORDERS_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("1.4b"));

pub(crate) struct OrdersFv20251001Profile;

impl Profile for OrdersFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Orders
    }
    fn release(&self) -> &Release {
        &RELEASE_ORDERS_FV20251001
    }
...
pub(crate) static PROFILE: OrdersFv20251001Profile = OrdersFv20251001Profile;
