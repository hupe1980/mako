...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-CONTRL-MIG-2.0b-ORDER", issues);
}
...
static RELEASE_CONTRL_FV20260101: LazyLock<Release> = LazyLock::new(|| Release::new("2.0b"));

pub(crate) struct ContrlFv20260101Profile;

impl Profile for ContrlFv20260101Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Contrl
    }
    fn release(&self) -> &Release {
        &RELEASE_CONTRL_FV20260101
    }
    fn valid_from(&self) -> Option<::time::Date> {
        Some(::time::macros::date!(2026 - 01 - 01))
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("CONTRL AHB 2.0b, Stand 01.01.2026")
    }
...
pub(crate) static PROFILE: ContrlFv20260101Profile = ContrlFv20260101Profile;
