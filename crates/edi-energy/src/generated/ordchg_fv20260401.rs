...
static RELEASE_ORDCHG_FV20260401: LazyLock<Release> = LazyLock::new(|| Release::new("1.2"));

pub(crate) struct OrdchgFv20260401Profile;

impl Profile for OrdchgFv20260401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Ordchg
    }
    fn release(&self) -> &Release {
        &RELEASE_ORDCHG_FV20260401
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("ORDCHG AHB 1.2, Stand 01.04.2026")
    }
...
pub(crate) static PROFILE: OrdchgFv20260401Profile = OrdchgFv20260401Profile;
