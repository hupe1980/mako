...
static RELEASE_QUOTES_FV20250401: LazyLock<Release> = LazyLock::new(|| Release::new("1.3b"));

pub(crate) struct QuotesFv20250401Profile;

impl Profile for QuotesFv20250401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Quotes
    }
    fn release(&self) -> &Release {
        &RELEASE_QUOTES_FV20250401
    }
...
pub(crate) static PROFILE: QuotesFv20250401Profile = QuotesFv20250401Profile;
