...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-QUOTES-MIG-1.3c-ORDER", issues);
}
    ...
    Arc::new(
        ProfileRulePack::new("QUOTES-MIG-1.3c")
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG4-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG11-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG27-LIN-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG1-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3c-GROUP-SG11-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static RELEASE_QUOTES_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("1.3c"));

pub(crate) struct QuotesFv20261001Profile;

impl Profile for QuotesFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Quotes
    }
    fn release(&self) -> &Release {
        &RELEASE_QUOTES_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("QUOTES MIG 1.3c, Publikationsdatum 01.04.2026")
    }
...
pub(crate) static PROFILE: QuotesFv20261001Profile = QuotesFv20261001Profile;
