...
fn expected_components(tag: &str, idx: usize) -> Option<u8> {
    match (tag, idx) {
        ("UNH" | "UNT" | "NAD" | "CTA" | "IDE" | "STS" | "FTX" | "LOC", 0)
        | ("BGM" | "STS", 2)
        | ("UNT" | "STS", 1) => Some(1),
        _ => None,
    }
...
static RELEASE_UTILMD_FV20241001_GAS: LazyLock<Release> = LazyLock::new(|| Release::new("G1.1"));

pub(crate) struct UtilmdFv20241001GasProfile;

impl Profile for UtilmdFv20241001GasProfile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilmd
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILMD_FV20241001_GAS
    }
...
pub(crate) static PROFILE: UtilmdFv20241001GasProfile = UtilmdFv20241001GasProfile;
