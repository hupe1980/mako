...
static RELEASE_MSCONS_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("2.4c"));

pub(crate) struct MsconsFv20251001Profile;

impl Profile for MsconsFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Mscons
    }
    fn release(&self) -> &Release {
        &RELEASE_MSCONS_FV20251001
    }
...
pub(crate) static PROFILE: MsconsFv20251001Profile = MsconsFv20251001Profile;
