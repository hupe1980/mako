    ...
    Arc::new(
        ProfileRulePack::new("UTILMD-MIG-G1.2")
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-G1.2-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-G1.2-GROUP-SG2-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-G1.2-GROUP-SG4-IDE-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-G1.2-GROUP-SG2-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-UTILMD-MIG-G1.2-GROUP-SG4-IDE-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
static AHB_44007_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44007")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44008_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44008")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44009_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44009")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44010_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44010")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44011_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44011")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44012_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44012")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44013_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44013")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44014_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44014")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44015_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44015")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44016_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44016")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44036_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44036")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44037_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44037")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
static AHB_44038_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(ProfileRulePack::new("UTILMD-AHB-G1.2-44038")
            .for_message_type("UTILMD")
            .for_release("G1.2")
...
impl Profile for UtilmdFv20261001GasProfile {
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("UTILMD MIG G1.2, Publikationsdatum 01.04.2026")
    }
