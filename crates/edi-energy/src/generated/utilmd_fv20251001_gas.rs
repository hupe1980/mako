...
static RELEASE_UTILMD_FV20251001_GAS: LazyLock<Release> = LazyLock::new(|| Release::new("G1.1"));

pub(crate) struct UtilmdFv20251001GasProfile;

impl Profile for UtilmdFv20251001GasProfile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilmd
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILMD_FV20251001_GAS
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("UTILMD MIG Gas G1.1 außerordentliche Veröffentlichung Stand 11.12.2025")
    }
...
pub(crate) static PROFILE: UtilmdFv20251001GasProfile = UtilmdFv20251001GasProfile;
