...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "STS",
        "Prüfstatus Antwort auf Summenzeitreihen",
        &[
    ...
    SegmentDefinition::new(
        "CNI",
        "Sendungsdaten",
        &[ElementRef::new(1, "1490", Status::Conditional, 1)],
    ),
    SegmentDefinition::new(
        "EFI",
        "Ansicht des Senders",
        &[ElementRef::new(1, "C077", Status::Mandatory, 1)],
    ),
    SegmentDefinition::new(
        "QTY",
        "Menge",
    ...
    SegmentDefinition::new(
        "GID",
        "Sendungspositionseinzelheiten",
        &[ElementRef::new(1, "1496", Status::Conditional, 1)],
    ),
    SegmentDefinition::new(
        "FTX",
        "Freier Text",
...
static CODES_1153: &[&str] = &["ACE", "ACW", "ADY", "AGI", "AUU", "TN", "Z13"];
static CODES_2005: &[&str] = &["137", "334", "492", "93"];
...
static DIRECTORY_VALIDATOR_IFTSTA_2_0G: LazyLock<DirectoryValidator> = LazyLock::new(|| {
    DirectoryValidator::new(
        "EDI@Energy-IFTSTA-2.0g",
        segment_lookup,
        is_code_valid,
        suggest_code,
        expected_components,
...
pub(crate) fn directory_validator() -> &'static DirectoryValidator {
    &DIRECTORY_VALIDATOR_IFTSTA_2_0G
}
        ...
        for &required_tag in MANDATORY_INNER {
            if !window.iter().any(|s| s.tag == required_tag) {
                issues.push(
                        ...
                        .with_rule_id("MIG-IFTSTA-MIG-2.0g-GROUP-EQD")
...
fn rule_group_sg1_nad_max_occurrences(
    ...
    if count > 2 {
        issues.push(
            ...
            .with_rule_id("MIG-IFTSTA-MIG-2.0g-GROUP-SG1-NAD-CARD-MAX")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
///
/// Counted over the group tree, so a nested group sharing the `EQD`
...
fn rule_group_sg4_eqd_max_occurrences(
    ...
    if count > 99_999 {
        issues.push(
            ...
            .with_rule_id("MIG-IFTSTA-MIG-2.0g-GROUP-SG4-EQD-CARD-MAX")
...
///
/// Counted over the group tree, so a nested group sharing the `CNI`
/// trigger is not charged here.  The MIG specifies a maximum of 99999 instances.
fn rule_group_sg14_cni_max_occurrences(
    ...
    // SG14 is not in GROUP_SCHEMA, so the tree cannot count it.
    ...
    if count > 99_999 {
        issues.push(
            ...
            .with_rule_id("MIG-IFTSTA-MIG-2.0g-GROUP-SG14-CNI-CARD-MAX")
...
fn rule_group_sg1_nad_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-IFTSTA-MIG-2.0g-GROUP-SG1-NAD-CARD-MIN")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-IFTSTA-MIG-2.0g-ORDER", issues);
}

static MIG_IFTSTA_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-MIG-2.0g")
            ...
            .with_rule_fn(rule_group_eqd_window)
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.0g-GROUP-SG1-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg1_nad_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.0g-GROUP-SG4-EQD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg4_eqd_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.0g-GROUP-SG14-CNI-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg14_cni_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-IFTSTA-MIG-2.0g-GROUP-SG1-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg1_nad_min_occurrences(g, segs, issues);
                    }
                },
            )
...
static AHB_21000_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21000")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21000-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21000-BGM-M",
            ...
            .with_named_rule_fn("AHB-21000-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21000-DTM-M",
            ...
            .with_named_rule_fn("AHB-21000-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21000-EQD-M",
            ...
            .with_named_rule_fn("AHB-21000-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21000-LOC-M",
            ...
            .with_named_rule_fn("AHB-21000-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21000-NAD-M",
            ...
            .with_named_rule_fn("AHB-21000-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21000-RFF-M",
            ...
            .with_named_rule_fn("AHB-21000-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21000-STS-M",
...
static AHB_21001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21001")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21001-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21001-BGM-M",
            ...
            .with_named_rule_fn("AHB-21001-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21001-DTM-M",
            ...
            .with_named_rule_fn("AHB-21001-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21001-EQD-M",
            ...
            .with_named_rule_fn("AHB-21001-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21001-LOC-M",
            ...
            .with_named_rule_fn("AHB-21001-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21001-NAD-M",
            ...
            .with_named_rule_fn("AHB-21001-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21001-RFF-M",
            ...
            .with_named_rule_fn("AHB-21001-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21001-STS-M",
...
static AHB_21002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21002")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21002-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21002-BGM-M",
            ...
            .with_named_rule_fn("AHB-21002-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21002-DTM-M",
            ...
            .with_named_rule_fn("AHB-21002-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21002-EQD-M",
            ...
            .with_named_rule_fn("AHB-21002-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21002-LOC-M",
            ...
            .with_named_rule_fn("AHB-21002-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21002-NAD-M",
            ...
            .with_named_rule_fn("AHB-21002-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21002-RFF-M",
            ...
            .with_named_rule_fn("AHB-21002-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21002-STS-M",
...
static AHB_21003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21003")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21003-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21003-BGM-M",
            ...
            .with_named_rule_fn("AHB-21003-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21003-DTM-M",
            ...
            .with_named_rule_fn("AHB-21003-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21003-EQD-M",
            ...
            .with_named_rule_fn("AHB-21003-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21003-LOC-M",
            ...
            .with_named_rule_fn("AHB-21003-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21003-NAD-M",
            ...
            .with_named_rule_fn("AHB-21003-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21003-RFF-M",
            ...
            .with_named_rule_fn("AHB-21003-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21003-STS-M",
...
static AHB_21004_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21004")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21004-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21004-BGM-M",
            ...
            .with_named_rule_fn("AHB-21004-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21004-DTM-M",
            ...
            .with_named_rule_fn("AHB-21004-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21004-EQD-M",
            ...
            .with_named_rule_fn("AHB-21004-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21004-LOC-M",
            ...
            .with_named_rule_fn("AHB-21004-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21004-NAD-M",
            ...
            .with_named_rule_fn("AHB-21004-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21004-RFF-M",
            ...
            .with_named_rule_fn("AHB-21004-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21004-STS-M",
...
static AHB_21005_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21005")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21005-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21005-BGM-M",
            ...
            .with_named_rule_fn("AHB-21005-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21005-DTM-M",
            ...
            .with_named_rule_fn("AHB-21005-EQD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EQD",
                    "AHB-21005-EQD-M",
            ...
            .with_named_rule_fn("AHB-21005-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21005-LOC-M",
            ...
            .with_named_rule_fn("AHB-21005-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21005-NAD-M",
            ...
            .with_named_rule_fn("AHB-21005-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21005-RFF-M",
            ...
            .with_named_rule_fn("AHB-21005-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21005-STS-M",
...
static AHB_21007_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21007")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21007-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21007-BGM-M",
            ...
            .with_named_rule_fn("AHB-21007-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21007-CNI-M",
            ...
            .with_named_rule_fn("AHB-21007-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21007-DTM-M",
            ...
            .with_named_rule_fn("AHB-21007-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21007-LOC-M",
            ...
            .with_named_rule_fn("AHB-21007-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21007-NAD-M",
            ...
            .with_named_rule_fn("AHB-21007-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21007-RFF-M",
            ...
            .with_named_rule_fn("AHB-21007-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21007-STS-M",
...
static AHB_21009_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21009")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21009-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21009-BGM-M",
            ...
            .with_named_rule_fn("AHB-21009-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21009-CNI-M",
            ...
            .with_named_rule_fn("AHB-21009-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21009-DTM-M",
            ...
            .with_named_rule_fn("AHB-21009-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21009-LOC-M",
            ...
            .with_named_rule_fn("AHB-21009-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21009-NAD-M",
            ...
            .with_named_rule_fn("AHB-21009-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21009-RFF-M",
            ...
            .with_named_rule_fn("AHB-21009-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21009-STS-M",
...
static AHB_21010_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21010")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21010-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21010-BGM-M",
            ...
            .with_named_rule_fn("AHB-21010-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21010-CNI-M",
            ...
            .with_named_rule_fn("AHB-21010-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21010-DTM-M",
            ...
            .with_named_rule_fn("AHB-21010-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21010-LOC-M",
            ...
            .with_named_rule_fn("AHB-21010-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21010-NAD-M",
            ...
            .with_named_rule_fn("AHB-21010-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21010-RFF-M",
            ...
            .with_named_rule_fn("AHB-21010-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21010-STS-M",
...
static AHB_21011_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21011")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21011-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21011-BGM-M",
            ...
            .with_named_rule_fn("AHB-21011-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21011-CNI-M",
            ...
            .with_named_rule_fn("AHB-21011-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21011-DTM-M",
            ...
            .with_named_rule_fn("AHB-21011-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21011-LOC-M",
            ...
            .with_named_rule_fn("AHB-21011-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21011-NAD-M",
            ...
            .with_named_rule_fn("AHB-21011-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21011-RFF-M",
            ...
            .with_named_rule_fn("AHB-21011-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21011-STS-M",
...
static AHB_21012_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21012")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21012-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21012-BGM-M",
            ...
            .with_named_rule_fn("AHB-21012-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21012-CNI-M",
            ...
            .with_named_rule_fn("AHB-21012-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21012-DTM-M",
            ...
            .with_named_rule_fn("AHB-21012-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21012-LOC-M",
            ...
            .with_named_rule_fn("AHB-21012-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21012-NAD-M",
            ...
            .with_named_rule_fn("AHB-21012-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21012-RFF-M",
            ...
            .with_named_rule_fn("AHB-21012-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21012-STS-M",
...
static AHB_21013_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21013")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21013-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21013-BGM-M",
            ...
            .with_named_rule_fn("AHB-21013-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21013-CNI-M",
            ...
            .with_named_rule_fn("AHB-21013-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21013-DTM-M",
            ...
            .with_named_rule_fn("AHB-21013-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21013-LOC-M",
            ...
            .with_named_rule_fn("AHB-21013-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21013-NAD-M",
            ...
            .with_named_rule_fn("AHB-21013-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21013-RFF-M",
            ...
            .with_named_rule_fn("AHB-21013-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21013-STS-M",
...
static AHB_21015_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21015")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21015-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21015-BGM-M",
            ...
            .with_named_rule_fn("AHB-21015-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21015-CNI-M",
            ...
            .with_named_rule_fn("AHB-21015-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21015-COM-M",
            ...
            .with_named_rule_fn("AHB-21015-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21015-CTA-M",
            ...
            .with_named_rule_fn("AHB-21015-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21015-DTM-M",
            ...
            .with_named_rule_fn("AHB-21015-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21015-LOC-M",
            ...
            .with_named_rule_fn("AHB-21015-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21015-NAD-M",
            ...
            .with_named_rule_fn("AHB-21015-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21015-RFF-M",
            ...
            .with_named_rule_fn("AHB-21015-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21015-STS-M",
...
static AHB_21018_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21018")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21018-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21018-BGM-M",
            ...
            .with_named_rule_fn("AHB-21018-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21018-CNI-M",
            ...
            .with_named_rule_fn("AHB-21018-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21018-DTM-M",
            ...
            .with_named_rule_fn("AHB-21018-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21018-LOC-M",
            ...
            .with_named_rule_fn("AHB-21018-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21018-NAD-M",
            ...
            .with_named_rule_fn("AHB-21018-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21018-RFF-M",
            ...
            .with_named_rule_fn("AHB-21018-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21018-STS-M",
...
static AHB_21024_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21024")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21024-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21024-BGM-M",
            ...
            .with_named_rule_fn("AHB-21024-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21024-CNI-M",
            ...
            .with_named_rule_fn("AHB-21024-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21024-COM-M",
            ...
            .with_named_rule_fn("AHB-21024-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21024-CTA-M",
            ...
            .with_named_rule_fn("AHB-21024-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21024-DTM-M",
            ...
            .with_named_rule_fn("AHB-21024-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21024-LOC-M",
            ...
            .with_named_rule_fn("AHB-21024-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21024-NAD-M",
            ...
            .with_named_rule_fn("AHB-21024-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21024-RFF-M",
            ...
            .with_named_rule_fn("AHB-21024-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21024-STS-M",
...
static AHB_21025_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21025")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21025-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21025-BGM-M",
            ...
            .with_named_rule_fn("AHB-21025-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21025-CNI-M",
            ...
            .with_named_rule_fn("AHB-21025-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21025-COM-M",
            ...
            .with_named_rule_fn("AHB-21025-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21025-CTA-M",
            ...
            .with_named_rule_fn("AHB-21025-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21025-DTM-M",
            ...
            .with_named_rule_fn("AHB-21025-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21025-FTX-M",
            ...
            .with_named_rule_fn("AHB-21025-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21025-GID-M",
            ...
            .with_named_rule_fn("AHB-21025-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21025-LOC-M",
            ...
            .with_named_rule_fn("AHB-21025-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21025-NAD-M",
            ...
            .with_named_rule_fn("AHB-21025-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21025-RFF-M",
            ...
            .with_named_rule_fn("AHB-21025-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21025-STS-M",
...
static AHB_21026_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21026")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21026-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21026-BGM-M",
            ...
            .with_named_rule_fn("AHB-21026-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21026-CNI-M",
            ...
            .with_named_rule_fn("AHB-21026-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21026-COM-M",
            ...
            .with_named_rule_fn("AHB-21026-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21026-CTA-M",
            ...
            .with_named_rule_fn("AHB-21026-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21026-DTM-M",
            ...
            .with_named_rule_fn("AHB-21026-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21026-LOC-M",
            ...
            .with_named_rule_fn("AHB-21026-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21026-NAD-M",
            ...
            .with_named_rule_fn("AHB-21026-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21026-RFF-M",
            ...
            .with_named_rule_fn("AHB-21026-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21026-STS-M",
...
static AHB_21027_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21027")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21027-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21027-BGM-M",
            ...
            .with_named_rule_fn("AHB-21027-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21027-CNI-M",
            ...
            .with_named_rule_fn("AHB-21027-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21027-COM-M",
            ...
            .with_named_rule_fn("AHB-21027-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21027-CTA-M",
            ...
            .with_named_rule_fn("AHB-21027-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21027-DTM-M",
            ...
            .with_named_rule_fn("AHB-21027-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21027-FTX-M",
            ...
            .with_named_rule_fn("AHB-21027-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21027-GID-M",
            ...
            .with_named_rule_fn("AHB-21027-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21027-LOC-M",
            ...
            .with_named_rule_fn("AHB-21027-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21027-NAD-M",
            ...
            .with_named_rule_fn("AHB-21027-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21027-RFF-M",
            ...
            .with_named_rule_fn("AHB-21027-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21027-STS-M",
...
static AHB_21028_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21028")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21028-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21028-BGM-M",
            ...
            .with_named_rule_fn("AHB-21028-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21028-CNI-M",
            ...
            .with_named_rule_fn("AHB-21028-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21028-DTM-M",
            ...
            .with_named_rule_fn("AHB-21028-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21028-LOC-M",
            ...
            .with_named_rule_fn("AHB-21028-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21028-NAD-M",
            ...
            .with_named_rule_fn("AHB-21028-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21028-RFF-M",
            ...
            .with_named_rule_fn("AHB-21028-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21028-STS-M",
...
static AHB_21029_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21029")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21029-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21029-BGM-M",
            ...
            .with_named_rule_fn("AHB-21029-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21029-CNI-M",
            ...
            .with_named_rule_fn("AHB-21029-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21029-DTM-M",
            ...
            .with_named_rule_fn("AHB-21029-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21029-LOC-M",
            ...
            .with_named_rule_fn("AHB-21029-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21029-NAD-M",
            ...
            .with_named_rule_fn("AHB-21029-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21029-RFF-M",
            ...
            .with_named_rule_fn("AHB-21029-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21029-STS-M",
...
static AHB_21030_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21030")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21030-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21030-BGM-M",
            ...
            .with_named_rule_fn("AHB-21030-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21030-CNI-M",
            ...
            .with_named_rule_fn("AHB-21030-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21030-DTM-M",
            ...
            .with_named_rule_fn("AHB-21030-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21030-LOC-M",
            ...
            .with_named_rule_fn("AHB-21030-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21030-NAD-M",
            ...
            .with_named_rule_fn("AHB-21030-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21030-RFF-M",
            ...
            .with_named_rule_fn("AHB-21030-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21030-STS-M",
...
static AHB_21031_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21031")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21031-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21031-BGM-M",
            ...
            .with_named_rule_fn("AHB-21031-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21031-CNI-M",
            ...
            .with_named_rule_fn("AHB-21031-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21031-DTM-M",
            ...
            .with_named_rule_fn("AHB-21031-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21031-LOC-M",
            ...
            .with_named_rule_fn("AHB-21031-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21031-NAD-M",
            ...
            .with_named_rule_fn("AHB-21031-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21031-RFF-M",
            ...
            .with_named_rule_fn("AHB-21031-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21031-STS-M",
...
static AHB_21032_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21032")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21032-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21032-BGM-M",
            ...
            .with_named_rule_fn("AHB-21032-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21032-CNI-M",
            ...
            .with_named_rule_fn("AHB-21032-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21032-DTM-M",
            ...
            .with_named_rule_fn("AHB-21032-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21032-FTX-M",
            ...
            .with_named_rule_fn("AHB-21032-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21032-GID-M",
            ...
            .with_named_rule_fn("AHB-21032-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21032-NAD-M",
            ...
            .with_named_rule_fn("AHB-21032-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21032-RFF-M",
            ...
            .with_named_rule_fn("AHB-21032-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21032-STS-M",
...
static AHB_21033_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21033")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21033-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21033-BGM-M",
            ...
            .with_named_rule_fn("AHB-21033-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21033-CNI-M",
            ...
            .with_named_rule_fn("AHB-21033-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21033-DTM-M",
            ...
            .with_named_rule_fn("AHB-21033-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21033-FTX-M",
            ...
            .with_named_rule_fn("AHB-21033-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21033-GID-M",
            ...
            .with_named_rule_fn("AHB-21033-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21033-NAD-M",
            ...
            .with_named_rule_fn("AHB-21033-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21033-RFF-M",
            ...
            .with_named_rule_fn("AHB-21033-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21033-STS-M",
...
static AHB_21035_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21035")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21035-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21035-BGM-M",
            ...
            .with_named_rule_fn("AHB-21035-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21035-CNI-M",
            ...
            .with_named_rule_fn("AHB-21035-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21035-DTM-M",
            ...
            .with_named_rule_fn("AHB-21035-EFI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EFI",
                    "AHB-21035-EFI-M",
            ...
            .with_named_rule_fn("AHB-21035-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21035-NAD-M",
            ...
            .with_named_rule_fn("AHB-21035-QTY-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "QTY",
                    "AHB-21035-QTY-M",
            ...
            .with_named_rule_fn("AHB-21035-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21035-RFF-M",
            ...
            .with_named_rule_fn("AHB-21035-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21035-STS-M",
...
static AHB_21036_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21036")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21036-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21036-BGM-M",
            ...
            .with_named_rule_fn("AHB-21036-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21036-CNI-M",
            ...
            .with_named_rule_fn("AHB-21036-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21036-DTM-M",
            ...
            .with_named_rule_fn("AHB-21036-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21036-LOC-M",
            ...
            .with_named_rule_fn("AHB-21036-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21036-NAD-M",
            ...
            .with_named_rule_fn("AHB-21036-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21036-RFF-M",
            ...
            .with_named_rule_fn("AHB-21036-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21036-STS-M",
...
static AHB_21037_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21037")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21037-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21037-BGM-M",
            ...
            .with_named_rule_fn("AHB-21037-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21037-CNI-M",
            ...
            .with_named_rule_fn("AHB-21037-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21037-COM-M",
            ...
            .with_named_rule_fn("AHB-21037-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21037-CTA-M",
            ...
            .with_named_rule_fn("AHB-21037-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21037-DTM-M",
            ...
            .with_named_rule_fn("AHB-21037-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21037-FTX-M",
            ...
            .with_named_rule_fn("AHB-21037-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21037-GID-M",
            ...
            .with_named_rule_fn("AHB-21037-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21037-NAD-M",
            ...
            .with_named_rule_fn("AHB-21037-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21037-RFF-M",
            ...
            .with_named_rule_fn("AHB-21037-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21037-STS-M",
...
static AHB_21038_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21038")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21038-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21038-BGM-M",
            ...
            .with_named_rule_fn("AHB-21038-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21038-CNI-M",
            ...
            .with_named_rule_fn("AHB-21038-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-21038-COM-M",
            ...
            .with_named_rule_fn("AHB-21038-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-21038-CTA-M",
            ...
            .with_named_rule_fn("AHB-21038-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21038-DTM-M",
            ...
            .with_named_rule_fn("AHB-21038-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21038-FTX-M",
            ...
            .with_named_rule_fn("AHB-21038-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21038-GID-M",
            ...
            .with_named_rule_fn("AHB-21038-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21038-NAD-M",
            ...
            .with_named_rule_fn("AHB-21038-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21038-RFF-M",
            ...
            .with_named_rule_fn("AHB-21038-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21038-STS-M",
...
static AHB_21039_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21039")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21039-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21039-BGM-M",
            ...
            .with_named_rule_fn("AHB-21039-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21039-CNI-M",
            ...
            .with_named_rule_fn("AHB-21039-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21039-DTM-M",
            ...
            .with_named_rule_fn("AHB-21039-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21039-FTX-M",
            ...
            .with_named_rule_fn("AHB-21039-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21039-GID-M",
            ...
            .with_named_rule_fn("AHB-21039-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21039-LOC-M",
            ...
            .with_named_rule_fn("AHB-21039-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21039-NAD-M",
            ...
            .with_named_rule_fn("AHB-21039-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21039-RFF-M",
            ...
            .with_named_rule_fn("AHB-21039-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21039-STS-M",
...
static AHB_21040_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21040")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21040-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21040-BGM-M",
            ...
            .with_named_rule_fn("AHB-21040-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21040-CNI-M",
            ...
            .with_named_rule_fn("AHB-21040-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21040-DTM-M",
            ...
            .with_named_rule_fn("AHB-21040-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21040-LOC-M",
            ...
            .with_named_rule_fn("AHB-21040-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21040-NAD-M",
            ...
            .with_named_rule_fn("AHB-21040-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21040-RFF-M",
            ...
            .with_named_rule_fn("AHB-21040-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21040-STS-M",
...
static AHB_21042_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21042")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21042-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21042-BGM-M",
            ...
            .with_named_rule_fn("AHB-21042-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21042-CNI-M",
            ...
            .with_named_rule_fn("AHB-21042-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21042-DTM-M",
            ...
            .with_named_rule_fn("AHB-21042-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21042-NAD-M",
            ...
            .with_named_rule_fn("AHB-21042-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21042-RFF-M",
            ...
            .with_named_rule_fn("AHB-21042-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21042-STS-M",
...
static AHB_21043_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21043")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21043-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21043-BGM-M",
            ...
            .with_named_rule_fn("AHB-21043-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21043-CNI-M",
            ...
            .with_named_rule_fn("AHB-21043-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21043-DTM-M",
            ...
            .with_named_rule_fn("AHB-21043-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21043-FTX-M",
            ...
            .with_named_rule_fn("AHB-21043-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21043-GID-M",
            ...
            .with_named_rule_fn("AHB-21043-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21043-NAD-M",
            ...
            .with_named_rule_fn("AHB-21043-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21043-RFF-M",
            ...
            .with_named_rule_fn("AHB-21043-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21043-STS-M",
...
static AHB_21044_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21044")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21044-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21044-BGM-M",
            ...
            .with_named_rule_fn("AHB-21044-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21044-CNI-M",
            ...
            .with_named_rule_fn("AHB-21044-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21044-DTM-M",
            ...
            .with_named_rule_fn("AHB-21044-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21044-NAD-M",
            ...
            .with_named_rule_fn("AHB-21044-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21044-RFF-M",
            ...
            .with_named_rule_fn("AHB-21044-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21044-STS-M",
...
static AHB_21045_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21045")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21045-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21045-BGM-M",
            ...
            .with_named_rule_fn("AHB-21045-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21045-CNI-M",
            ...
            .with_named_rule_fn("AHB-21045-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21045-DTM-M",
            ...
            .with_named_rule_fn("AHB-21045-EFI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "EFI",
                    "AHB-21045-EFI-M",
            ...
            .with_named_rule_fn("AHB-21045-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21045-FTX-M",
            ...
            .with_named_rule_fn("AHB-21045-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21045-GID-M",
            ...
            .with_named_rule_fn("AHB-21045-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-21045-LOC-M",
            ...
            .with_named_rule_fn("AHB-21045-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21045-NAD-M",
            ...
            .with_named_rule_fn("AHB-21045-QTY-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "QTY",
                    "AHB-21045-QTY-M",
            ...
            .with_named_rule_fn("AHB-21045-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21045-RFF-M",
            ...
            .with_named_rule_fn("AHB-21045-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21045-STS-M",
...
static AHB_21047_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("IFTSTA-AHB-2.0g-21047")
            .for_message_type("IFTSTA")
            .for_release("2.0g")
            .with_named_rule_fn("AHB-21047-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-21047-BGM-M",
            ...
            .with_named_rule_fn("AHB-21047-CNI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CNI",
                    "AHB-21047-CNI-M",
            ...
            .with_named_rule_fn("AHB-21047-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-21047-DTM-M",
            ...
            .with_named_rule_fn("AHB-21047-FTX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "FTX",
                    "AHB-21047-FTX-M",
            ...
            .with_named_rule_fn("AHB-21047-GID-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "GID",
                    "AHB-21047-GID-M",
            ...
            .with_named_rule_fn("AHB-21047-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-21047-NAD-M",
            ...
            .with_named_rule_fn("AHB-21047-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-21047-RFF-M",
            ...
            .with_named_rule_fn("AHB-21047-STS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "STS",
                    "AHB-21047-STS-M",
...
static AHB_ALL_PACK_IFTSTA_2_0G: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    let pack = ProfileRulePack::new("IFTSTA-AHB-2.0g-ALL")
        .for_message_type("IFTSTA")
        .for_release("2.0g");
    let pack = pack
...
pub(crate) fn ahb_rule_pack(pid: Option<Pruefidentifikator>) -> Arc<ProfileRulePack> {
    match pid.map(super::super::pruefidentifikator::Pruefidentifikator::as_u32) {
            ...
            None => Arc::clone(&AHB_ALL_PACK_IFTSTA_2_0G),
...
static RELEASE_IFTSTA_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("2.0g"));

pub(crate) struct IftstaFv20251001Profile;

impl Profile for IftstaFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Iftsta
    }
    fn release(&self) -> &Release {
        &RELEASE_IFTSTA_FV20251001
    }
...
pub(crate) static PROFILE: IftstaFv20251001Profile = IftstaFv20251001Profile;
