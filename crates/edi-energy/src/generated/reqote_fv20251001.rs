...
static RELEASE_REQOTE_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("1.3c"));

pub(crate) struct ReqoteFv20251001Profile;

impl Profile for ReqoteFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Reqote
    }
    fn release(&self) -> &Release {
        &RELEASE_REQOTE_FV20251001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("REQOTE MIG 1.3c, Publikationsdatum 01.04.2025")
    }
...
pub(crate) static PROFILE: ReqoteFv20251001Profile = ReqoteFv20251001Profile;
