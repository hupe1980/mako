    ...
    Arc::new(
        ProfileRulePack::new("REMADV-MIG-2.9e")
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG1-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG4-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG5-DOC-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG1-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG4-CUX-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9e-GROUP-SG5-DOC-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
...
impl Profile for RemadvFv20260401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Remadv
    }
    fn release(&self) -> &Release {
        &RELEASE_REMADV_FV20260401
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("REMADV MIG 2.9e (valid from 2026-04-01, open-ended) / REMADV AHB 1.0a")
    }
...
pub(crate) static PROFILE: RemadvFv20260401Profile = RemadvFv20260401Profile;
