...
static RELEASE_UTILTS_FV20241001: LazyLock<Release> = LazyLock::new(|| Release::new("1.1e"));

pub(crate) struct UtiltsFv20241001Profile;

impl Profile for UtiltsFv20241001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilts
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILTS_FV20241001
    }
...
pub(crate) static PROFILE: UtiltsFv20241001Profile = UtiltsFv20241001Profile;
