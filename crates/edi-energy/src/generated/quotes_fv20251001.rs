...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "PRI",
        "Preisangaben",
        &[ElementRef::new(1, "C509", Status::Conditional, 1)],
    ),
    SegmentDefinition::new(
        "UNT",
...
static DIRECTORY_VALIDATOR_QUOTES_1_3B: LazyLock<DirectoryValidator> = LazyLock::new(|| {
    DirectoryValidator::new(
        "EDI@Energy-QUOTES-1.3b",
        segment_lookup,
        is_code_valid,
        suggest_code,
        expected_components,
...
pub(crate) fn directory_validator() -> &'static DirectoryValidator {
    &DIRECTORY_VALIDATOR_QUOTES_1_3B
}
...
fn rule_group_sg1_rff_max_occurrences(
    ...
    if count > 9_999 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG1-RFF-CARD-MAX")
            .with_segment("RFF".to_owned()),
        );
    }
}
...
/// trigger is not charged here.  The MIG specifies a maximum of 5 instances.
fn rule_group_sg4_cux_max_occurrences(
    ...
    if count > 5 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG4-CUX-CARD-MAX")
...
fn rule_group_sg11_nad_max_occurrences(
    ...
    // SG11 is not in GROUP_SCHEMA, so the tree cannot count it.
    ...
    if count > 99 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG11-NAD-CARD-MAX")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_group_sg27_lin_max_occurrences(
    ...
    if count > 200_000 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG27-LIN-CARD-MAX")
...
fn rule_group_sg1_rff_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG1-RFF-CARD-MIN")
            .with_segment("RFF".to_owned()),
        );
    }
}
...
fn rule_group_sg11_nad_min_occurrences(
    ...
    if count < 1 {
        issues.push(
            ...
            .with_rule_id("MIG-QUOTES-MIG-1.3b-GROUP-SG11-NAD-CARD-MIN")
            .with_segment("NAD".to_owned()),
        );
    }
}
...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    fn group_order(name: &str) -> &'static [&'static str] {
        match name {
            "ROOT" => &[
                "UNH", "BGM", "DTM", "IMD", "FTX", "NAD", "CTA", "COM", "LOC", "LIN", "PIA", "GIN",
                "CCI", "CAV", "PRI", "UNT",
            ],
            "SG1" | "SG32" => &["RFF"],
            "SG4" => &["CUX"],
    ...
    check_order(&tree, segments, "MIG-QUOTES-MIG-1.3b-ORDER", issues);
}

static MIG_QUOTES_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-MIG-1.3b")
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG1-RFF-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG4-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg4_cux_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG11-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg11_nad_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG27-LIN-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG1-RFF-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-QUOTES-MIG-1.3b-GROUP-SG11-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg11_nad_min_occurrences(g, segs, issues);
                    }
                },
            )
...
static AHB_15001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-AHB-1.3b-15001")
            .for_message_type("QUOTES")
            .for_release("1.3b")
            .with_named_rule_fn("AHB-15001-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-15001-BGM-M",
            ...
            .with_named_rule_fn("AHB-15001-CAV-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CAV",
                    "AHB-15001-CAV-M",
            ...
            .with_named_rule_fn("AHB-15001-CCI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CCI",
                    "AHB-15001-CCI-M",
            ...
            .with_named_rule_fn("AHB-15001-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-15001-COM-M",
            ...
            .with_named_rule_fn("AHB-15001-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-15001-CTA-M",
            ...
            .with_named_rule_fn("AHB-15001-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-15001-CUX-M",
            ...
            .with_named_rule_fn("AHB-15001-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-15001-DTM-M",
            ...
            .with_named_rule_fn("AHB-15001-IMD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "IMD",
                    "AHB-15001-IMD-M",
            ...
            .with_named_rule_fn("AHB-15001-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-15001-LIN-M",
            ...
            .with_named_rule_fn("AHB-15001-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-15001-LOC-M",
            ...
            .with_named_rule_fn("AHB-15001-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-15001-NAD-M",
            ...
            .with_named_rule_fn("AHB-15001-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-15001-PRI-M",
            ...
            .with_named_rule_fn("AHB-15001-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-15001-RFF-M",
...
static AHB_15002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-AHB-1.3b-15002")
            .for_message_type("QUOTES")
            .for_release("1.3b")
            .with_named_rule_fn("AHB-15002-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-15002-BGM-M",
            ...
            .with_named_rule_fn("AHB-15002-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-15002-COM-M",
            ...
            .with_named_rule_fn("AHB-15002-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-15002-CTA-M",
            ...
            .with_named_rule_fn("AHB-15002-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-15002-CUX-M",
            ...
            .with_named_rule_fn("AHB-15002-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-15002-DTM-M",
            ...
            .with_named_rule_fn("AHB-15002-IMD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "IMD",
                    "AHB-15002-IMD-M",
            ...
            .with_named_rule_fn("AHB-15002-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-15002-LIN-M",
            ...
            .with_named_rule_fn("AHB-15002-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-15002-LOC-M",
            ...
            .with_named_rule_fn("AHB-15002-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-15002-NAD-M",
            ...
            .with_named_rule_fn("AHB-15002-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-15002-PIA-M",
            ...
            .with_named_rule_fn("AHB-15002-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-15002-PRI-M",
            ...
            .with_named_rule_fn("AHB-15002-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-15002-RFF-M",
...
static AHB_15003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-AHB-1.3b-15003")
            .for_message_type("QUOTES")
            .for_release("1.3b")
            .with_named_rule_fn("AHB-15003-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-15003-BGM-M",
            ...
            .with_named_rule_fn("AHB-15003-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-15003-COM-M",
            ...
            .with_named_rule_fn("AHB-15003-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-15003-CTA-M",
            ...
            .with_named_rule_fn("AHB-15003-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-15003-CUX-M",
            ...
            .with_named_rule_fn("AHB-15003-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-15003-DTM-M",
            ...
            .with_named_rule_fn("AHB-15003-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-15003-LOC-M",
            ...
            .with_named_rule_fn("AHB-15003-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-15003-NAD-M",
            ...
            .with_named_rule_fn("AHB-15003-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-15003-PIA-M",
            ...
            .with_named_rule_fn("AHB-15003-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-15003-PRI-M",
            ...
            .with_named_rule_fn("AHB-15003-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-15003-RFF-M",
            ...
            .with_named_rule_fn("AHB-15003-LIN-S", |segs, issues| {
                ahb_check_soll(
                    segs,
                    "LIN",
                    "AHB-15003-LIN-S",
                    "segment LIN should be present for Pruefidentifikator 15003 (Soll)",
                    "15003",
                    issues,
                );
            })
...
static AHB_15004_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-AHB-1.3b-15004")
            .for_message_type("QUOTES")
            .for_release("1.3b")
            .with_named_rule_fn("AHB-15004-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-15004-BGM-M",
            ...
            .with_named_rule_fn("AHB-15004-CCI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CCI",
                    "AHB-15004-CCI-M",
            ...
            .with_named_rule_fn("AHB-15004-COM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "COM",
                    "AHB-15004-COM-M",
            ...
            .with_named_rule_fn("AHB-15004-CTA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CTA",
                    "AHB-15004-CTA-M",
            ...
            .with_named_rule_fn("AHB-15004-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-15004-DTM-M",
            ...
            .with_named_rule_fn("AHB-15004-IMD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "IMD",
                    "AHB-15004-IMD-M",
            ...
            .with_named_rule_fn("AHB-15004-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-15004-LIN-M",
            ...
            .with_named_rule_fn("AHB-15004-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-15004-LOC-M",
            ...
            .with_named_rule_fn("AHB-15004-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-15004-NAD-M",
            ...
            .with_named_rule_fn("AHB-15004-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-15004-PIA-M",
            ...
            .with_named_rule_fn("AHB-15004-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-15004-RFF-M",
...
static AHB_15005_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("QUOTES-AHB-1.3b-15005")
            .for_message_type("QUOTES")
            .for_release("1.3b")
            .with_named_rule_fn("AHB-15005-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-15005-BGM-M",
            ...
            .with_named_rule_fn("AHB-15005-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-15005-DTM-M",
            ...
            .with_named_rule_fn("AHB-15005-LIN-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LIN",
                    "AHB-15005-LIN-M",
            ...
            .with_named_rule_fn("AHB-15005-LOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "LOC",
                    "AHB-15005-LOC-M",
            ...
            .with_named_rule_fn("AHB-15005-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-15005-NAD-M",
            ...
            .with_named_rule_fn("AHB-15005-PIA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PIA",
                    "AHB-15005-PIA-M",
            ...
            .with_named_rule_fn("AHB-15005-PRI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "PRI",
                    "AHB-15005-PRI-M",
            ...
            .with_named_rule_fn("AHB-15005-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-15005-RFF-M",
            ...
            .with_named_rule_fn("AHB-15005-RNG-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RNG",
                    "AHB-15005-RNG-M",
...
static AHB_ALL_PACK_QUOTES_1_3B: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    let pack = ProfileRulePack::new("QUOTES-AHB-1.3b-ALL")
        .for_message_type("QUOTES")
        .for_release("1.3b");
    let pack = pack
...
pub(crate) fn ahb_rule_pack(pid: Option<Pruefidentifikator>) -> Arc<ProfileRulePack> {
    match pid.map(super::super::pruefidentifikator::Pruefidentifikator::as_u32) {
            ...
            None => Arc::clone(&AHB_ALL_PACK_QUOTES_1_3B),
...
static RELEASE_QUOTES_FV20251001: LazyLock<Release> = LazyLock::new(|| Release::new("1.3b"));

pub(crate) struct QuotesFv20251001Profile;

impl Profile for QuotesFv20251001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Quotes
    }
    fn release(&self) -> &Release {
        &RELEASE_QUOTES_FV20251001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("QUOTES MIG 1.3b, Publikationsdatum 01.04.2025")
    }
...
pub(crate) static PROFILE: QuotesFv20251001Profile = QuotesFv20251001Profile;
