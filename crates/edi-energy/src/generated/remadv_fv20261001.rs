...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "DTM",
        "Date/Time/Period (Dokumentendatum)",
    ...
    SegmentDefinition::new(
        "CUX",
        "Currencies (Zahlungswährung)",
        &[ElementRef::new(1, "C504", Status::Mandatory, 1)],
    ),
    SegmentDefinition::new(
        "DOC",
        "Document/Message Details (Rückmeldung)",
        &[
            ElementRef::new(1, "C002", Status::Mandatory, 1),
    ...
    SegmentDefinition::new(
        "AJT",
        "Adjustment Details (Abweichungsgrund)",
        &[
    ...
    SegmentDefinition::new(
        ...
        &[ElementRef::new(1, "1082", Status::Mandatory, 1)],
    ),
    SegmentDefinition::new(
        "UNS",
        "Section Control",
...
static MIG_REMADV_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REMADV-MIG-2.9f")
            ...
            .with_rule_fn(rule_group_doc_window)
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG1-NAD-CARD-MAX",
                |g, segs, _ctx, issues| {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG4-CUX-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG5-DOC-CARD-MAX",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg5_doc_max_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG1-NAD-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
            ...
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG4-CUX-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg4_cux_min_occurrences(g, segs, issues);
                    }
                },
            )
            .with_named_group_rule_fn(
                "MIG-REMADV-MIG-2.9f-GROUP-SG5-DOC-CARD-MIN",
                |g, segs, _ctx, issues| {
                    if g.definition == "ROOT" {
                        rule_group_sg5_doc_min_occurrences(g, segs, issues);
                    }
                },
            )
...
static AHB_33001_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REMADV-AHB-2.9f-33001")
            .for_message_type("REMADV")
            .for_release("2.9f")
            .with_named_rule_fn("AHB-33001-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-33001-BGM-M",
            ...
            .with_named_rule_fn("AHB-33001-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-33001-CUX-M",
            ...
            .with_named_rule_fn("AHB-33001-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-33001-DOC-M",
            ...
            .with_named_rule_fn("AHB-33001-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-33001-DTM-M",
            ...
            .with_named_rule_fn("AHB-33001-MOA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "MOA",
                    "AHB-33001-MOA-M",
            ...
            .with_named_rule_fn("AHB-33001-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-33001-NAD-M",
            ...
            .with_named_rule_fn("AHB-33001-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-33001-RFF-M",
            ...
            .with_named_rule_fn("AHB-33001-UNS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "UNS",
                    "AHB-33001-UNS-M",
...
static AHB_33002_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REMADV-AHB-2.9f-33002")
            .for_message_type("REMADV")
            .for_release("2.9f")
            .with_named_rule_fn("AHB-33002-AJT-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "AJT",
                    "AHB-33002-AJT-M",
            ...
            .with_named_rule_fn("AHB-33002-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-33002-BGM-M",
            ...
            .with_named_rule_fn("AHB-33002-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-33002-CUX-M",
            ...
            .with_named_rule_fn("AHB-33002-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-33002-DOC-M",
            ...
            .with_named_rule_fn("AHB-33002-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-33002-DTM-M",
            ...
            .with_named_rule_fn("AHB-33002-MOA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "MOA",
                    "AHB-33002-MOA-M",
            ...
            .with_named_rule_fn("AHB-33002-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-33002-NAD-M",
            ...
            .with_named_rule_fn("AHB-33002-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-33002-RFF-M",
            ...
            .with_named_rule_fn("AHB-33002-UNS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "UNS",
                    "AHB-33002-UNS-M",
...
static AHB_33003_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REMADV-AHB-2.9f-33003")
            .for_message_type("REMADV")
            .for_release("2.9f")
            .with_named_rule_fn("AHB-33003-AJT-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "AJT",
                    "AHB-33003-AJT-M",
            ...
            .with_named_rule_fn("AHB-33003-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-33003-BGM-M",
            ...
            .with_named_rule_fn("AHB-33003-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-33003-CUX-M",
            ...
            .with_named_rule_fn("AHB-33003-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-33003-DOC-M",
            ...
            .with_named_rule_fn("AHB-33003-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-33003-DTM-M",
            ...
            .with_named_rule_fn("AHB-33003-MOA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "MOA",
                    "AHB-33003-MOA-M",
            ...
            .with_named_rule_fn("AHB-33003-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-33003-NAD-M",
            ...
            .with_named_rule_fn("AHB-33003-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-33003-RFF-M",
            ...
            .with_named_rule_fn("AHB-33003-UNS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "UNS",
                    "AHB-33003-UNS-M",
...
static AHB_33004_PACK: LazyLock<Arc<ProfileRulePack>> = LazyLock::new(|| {
    Arc::new(
        ProfileRulePack::new("REMADV-AHB-2.9f-33004")
            .for_message_type("REMADV")
            .for_release("2.9f")
            .with_named_rule_fn("AHB-33004-AJT-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "AJT",
                    "AHB-33004-AJT-M",
            ...
            .with_named_rule_fn("AHB-33004-BGM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "BGM",
                    "AHB-33004-BGM-M",
            ...
            .with_named_rule_fn("AHB-33004-CUX-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "CUX",
                    "AHB-33004-CUX-M",
            ...
            .with_named_rule_fn("AHB-33004-DLI-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DLI",
                    "AHB-33004-DLI-M",
            ...
            .with_named_rule_fn("AHB-33004-DOC-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DOC",
                    "AHB-33004-DOC-M",
            ...
            .with_named_rule_fn("AHB-33004-DTM-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "DTM",
                    "AHB-33004-DTM-M",
            ...
            .with_named_rule_fn("AHB-33004-MOA-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "MOA",
                    "AHB-33004-MOA-M",
            ...
            .with_named_rule_fn("AHB-33004-NAD-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "NAD",
                    "AHB-33004-NAD-M",
            ...
            .with_named_rule_fn("AHB-33004-RFF-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "RFF",
                    "AHB-33004-RFF-M",
            ...
            .with_named_rule_fn("AHB-33004-UNS-M", |segs, issues| {
                ahb_check_mandatory(
                    segs,
                    "UNS",
                    "AHB-33004-UNS-M",
...
static RELEASE_REMADV_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("2.9f"));

pub(crate) struct RemadvFv20261001Profile;

impl Profile for RemadvFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Remadv
    }
    fn release(&self) -> &Release {
        &RELEASE_REMADV_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some(
            "REMADV MIG 2.9e / AHB 2.9f, Publikationsdatum 01.04.2026 — SCAFFOLD: verify against BDEW publication before production use",
        )
    }
...
pub(crate) static PROFILE: RemadvFv20261001Profile = RemadvFv20261001Profile;
