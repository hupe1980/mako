...
static SEGMENTS: &[SegmentDefinition] = &[
    ...
    SegmentDefinition::new(
        "CCI",
        "Charakteristikum/Klasse-Information",
        &[
...
fn rule_segment_order(segments: &[edifact_rs::Segment<'_>], issues: &mut Vec<ValidationIssue>) {
    ...
    check_order(&tree, segments, "MIG-UTILTS-MIG-1.1e-ORDER", issues);
}
...
static RELEASE_UTILTS_FV20250401: LazyLock<Release> = LazyLock::new(|| Release::new("1.1e"));

pub(crate) struct UtiltsFv20250401Profile;

impl Profile for UtiltsFv20250401Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilts
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILTS_FV20250401
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("UTILTS MIG 1.1e, Publikationsdatum 01.10.2024")
    }
...
pub(crate) static PROFILE: UtiltsFv20250401Profile = UtiltsFv20250401Profile;
