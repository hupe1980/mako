...
static RELEASE_UTILTS_FV20261001: LazyLock<Release> = LazyLock::new(|| Release::new("1.1e"));

pub(crate) struct UtiltsFv20261001Profile;

impl Profile for UtiltsFv20261001Profile {
    fn message_type(&self) -> MessageType {
        MessageType::Utilts
    }
    fn release(&self) -> &Release {
        &RELEASE_UTILTS_FV20261001
    }
    ...
    fn source_document(&self) -> Option<&'static str> {
        Some("UTILTS MIG 1.1e, Publikationsdatum 01.04.2026")
    }
...
pub(crate) static PROFILE: UtiltsFv20261001Profile = UtiltsFv20261001Profile;
