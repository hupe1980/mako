...
crates/metering/            Pure Hampel-filter quality scoring for time-series meter data — hampel_filter(), score_intervals(), QualityGrade A/B/C/F; no I/O; 15 tests
