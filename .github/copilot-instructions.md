...
**Not workspace members.** `metering` (0.23), `meterstore` (0.11), `billing`, `en16931`,
`sepa` (0.7), `doubleentry`, `rubo4e`, `agentplane`, `asx-rs` and `edifact-rs` are
...
cargo xtask check-licenses            # the licence governance page states deny.toml's allow list, both directions
