...
| CloudEvents emitted | `de.messwert.reading.direct.stored`, `de.messwert.reading.quality.warning` (grade C/F), `de.messwert.reading.order.failed`, `de.messwert.cls.compliance-issue`, `de.messwert.smgw.cert.expiry-warning` |
