...
use billing::{
    BillingDocument, DocumentMeta, EuroAmount, LineItem, Quantity, Tariff, TaxLayer, UnitPrice,
};
...
mod tests {
    ...
    fn strom_tariff(gp_ct: f64, ap_ct: f64) -> TariffInput {
        TariffInput {
            ...
            steuerungsrabatt_modul1_eur_per_kw_year: None,
            steuerungsrabatt_modul3_eur_per_kw_year: None,
            gas_grundpreis_ct_per_day: None,
            gas_arbeitspreis_ct_per_kwh_hs: None,
            waerme_grundpreis_eur_per_month: None,
            waerme_arbeitspreis_ct_per_kwh: None,
            waerme_leistungspreis_eur_per_kw_month: None,
            solar_arbeitspreis_ct_per_kwh: None,
            mieterstrom_aufschlag_ct_per_kwh: None,
            gemeinschaft_rabatt_ct_per_kwh: None,
            solar_include_stromsteuer: false,
            eeg_verguetungssatz_ct_per_kwh: None,
            eeg_marktpraemie_ct_per_kwh: None,
            eeg_managementpraemie_ct_per_kwh: None,
            kwkg_zuschlag_ct_per_kwh: None,
            marktwert_ct_per_kwh: None,
            vermarktungsgebuehr_ct_per_kwh: None,
            hems_platform_fee_eur_per_month: None,
            hems_optimization_event_eur: None,
            hems_readout_event_eur: None,
            emobility_service_fee_eur_per_month: None,
            emobility_arbeitspreis_ct_per_kwh: None,
            emobility_session_fee_eur: None,
            emobility_roaming_fee_eur: None,
            service_fee_eur: None,
            service_event_price_eur: None,
            stromsteuer_ct_per_kwh_override: None,
            energiesteuer_gas_ct_per_kwh_override: None,
            behg_gas_ct_per_kwh_override: None,
