...
before billing.",
    ...
    async fn list_product_categories(
        ...
        let categories = serde_json::json!([
            ...
            { "category": "WAERMEPUMPE", "description": "Heat pump electricity with §14a EnWG Steuerungsrabatt Modul 1/3", "required": ["arbeitspreis_ct_per_kwh"], "optional": ["sect14a_modul1_pauschale_eur_per_year", "sect14a_steuerungsentschaedigung_eur_per_kw_year"], "meter": "meter.steuerung_stunden (Modul 3 only — Modul 1 is a flat annual amount and needs no Leistung)", "regulatory": "§14a EnWG; BNetzA BK8-22/010-A (23.11.2023), in force 01.01.2024 — applies to steuerbare Verbrauchseinrichtungen above 4.2 kW Netzanschlussleistung" },
        ...
        vec![
            ...
            PromptMessage::new_text(
                ...
                **Modul 1 — pauschale Reduzierung (a flat amount per year)**\n\
                ...
                BK8-22/010-A sets the amount as `80 EUR + 3 750 kWh × Arbeitspreis × 0,2`, so it has\n\
                ...
                **Regulatory basis:** §14a EnWG, BNetzA Festlegung BK8-22/010-A (23.11.2023),\n\
        ...
        vec![
            ...
            PromptMessage::new_text(
                ...
                **Regulatory rates (configure in billingd.toml `[rates]`):**\n\
                ...
                | BEHG CO₂ | 1.08836784 ct/kWh_Hs | 60 EUR/t CO₂ × 0.18139464 kg/kWh_Hs (2026 default, \
                 § 4 Abs. 1 Nr. 2 CO2KostAufG Mittelwert); \
