...
async fn bilanzierung_temporal_resource_resolves_by_point_in_time() {
    ...
    let mk = |beginn, ende, bk: &str| BilanzierungRecord {
        ...
        aggregationsverantwortung: Some("VNB".to_owned()),
        abwicklungsmodell: Some("MODELL_1".to_owned()),
        aggregationszustaendigkeit: Some("VERTEILNETZBETREIBER".to_owned()),
        ...
        bo4e_version: mako_markt::bo4e::schema_version(),
...
async fn bilanzierung_write_derives_the_malo_fallgruppe_column() {
    ...
    repo.upsert(&BilanzierungRecord {
        ...
        abwicklungsmodell: None,
        aggregationszustaendigkeit: None,
