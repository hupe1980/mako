...
use mako_gpke::{
    ...
    ANKUENDIGUNG_ZUORDNUNG_LF_WORKFLOW_NAME, BEENDIGUNG_ZUORDNUNG_WORKFLOW_NAME,
    DATENABRUF_WORKFLOW_NAME, KONFIGURATION_AENDERUNG_WORKFLOW_NAME, KONFIGURATION_WORKFLOW_NAME,
    LF_ABMELDUNG_WORKFLOW_NAME, LF_ANMELDUNG_WORKFLOW_NAME, MESSWERTE_WORKFLOW_NAME,
    NEUANLAGE_WORKFLOW_NAME, PARTIN_WORKFLOW_NAME, SPERRUNG_LF_WORKFLOW_NAME,
...
pub(crate) fn validate_adapter_coverage() {
    ...
    let checks: &[(&str, _)] = &[
        ...
        (
            BEENDIGUNG_ZUORDNUNG_WORKFLOW_NAME,
            adapters::gpke_beendigung_zuordnung_registry().validate_policy(fc, &known),
        ),
        (
