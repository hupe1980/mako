...
//! - **PID** (55001 vs 55002 vs 55017) — implied by the command name; ERP never sends this
...
//! | `gpke.kuendigung.anmelden` | `LF` | GPKE Kündigung Lieferbeginn | 55017 |
//! | `gpke.sperrung.bestaetigen` | `LF` | GPKE Sperrung bestätigt (LFN) | 55555 |
...
//! | `wim.geraetewechsel.beauftragen` | `NB`/`MSB` | WiM Gerätewechsel | 11001 |
//! | `wim.geraetewechsel.bestaetigen` | `MSB` | WiM Gerätewechsel abgeschlossen | 11001 |
...
async fn dispatch_command(
    ...
    match command {
        ...
        "gpke.kuendigung.anmelden" => {
            dispatch_lf_anmeldung(state, payload, 55017, "kuendigung_datum").await
        }
...
async fn dispatch_lf_anmeldung(
    ...
    // Optional: ERP may supply `alter_lf_gln` for Kündigung (PID 55017) when
...
fn validate_command(
    ...
    const REGISTRY: &[(&str, &[&str])] = &[
        ...
        // LF sends Kündigung Lieferbeginn to old LFA — PID 55017
        ("gpke.kuendigung.anmelden", &["LF"]),
        // LF confirms Sperrung execution to NB — PID 55555
        ...
        // ── WiM Gerätewechsel / Messwesen ─────────────────────────────────────
        // NB or MSB initiates a meter-device change — PID 11001
        ("wim.geraetewechsel.beauftragen", &["NB", "MSB"]),
        // MSB confirms the physical device swap — PID 11001
