...
docker pull ghcr.io/hupe1980/makod:0.10.0

# Smoke-test the image
docker run --rm ghcr.io/hupe1980/makod:0.10.0 --check
```

Images are tagged with the semver version (`0.10.0`), major.minor (`0.9`), and `latest`.
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: makod
          image: ghcr.io/hupe1980/makod:0.10.0
          ports:
...
```toml
edi-energy = { version = "0.10", features = ["tracing"] }
```
