...
| `agentd` | `:9580` | All | Multi-agent LLM orchestration — **28 declarative specialist manifests** run on the [agentplane](https://github.com/hupe1980/agentplane) durable runtime; every model and tool call is a journaled effect; human approval on mutating tools; A2A agent cards; Anthropic, OpenAI, AWS Bedrock |
