...
| `mako-wim` | WiM Strom workflows — MSB-Wechsel UTILMD (55039, 55042, 55051, 55168, answered with `SG4 STS+E01` out of `E_0200`/`E_0201`/`E_0202`/`E_0240`) + the IFTSTA Gesamtvorgang leg 21009–21013 that makes the Zuordnung constitutive + Geräteübernahme ORDERS 17001 → ORDRSP 19001/19002 and Gerätewechselabsicht 17009 → 19015/19016 + Weiterverpflichtung 17002 → 19003/19004 (`E_0203`) + Stammdaten + Preisanfrage REQOTE/QUOTES (35001/35002/35004/35005 → 15001/15002/15004/15005, four different Fristen) + Preisliste PRICAT (27001–27003) + Technik-Änderung (17011/17118 → 19005/19006) + Rechnungsabwicklung über den LF (17005/17006 → 19009/19010) + INSRPT (23001/23003/23004/23008) + iMS Steuerungsauftrag + MSB-Rechnung INVOIC (31009). **WiM Teil 2 ESA Wertebestellung** (§34 MsbG) — one `wim-wertebestellung`/`esa-wertebestellung` process spans REQOTE **35003** → QUOTES 15003 → ORDERS 17007/17008 → ORDRSP 19011/19012 → ORDCHG 39002 Storno → ORDRSP 19013/19014, plus MSCONS 13027 Werte-nach-Typ-2 delivery |
