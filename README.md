...
| 🧪 **Profiles read from the BDEW PDFs** | 32 profiles across 17 types, generated by `cargo xtask import-profiles` from the MIG and AHB documents — every Anwendungsfall's skeleton validates against its own Prüfschablone |
